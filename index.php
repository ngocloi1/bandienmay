...
<body>
	...
	<div class="faqs-w3l py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
            ...
            <h3 class="w3-head mb-2">Top 2 Frequently asked questions</h3>
                        ...
                        <ul>
                            <li class="subitem1">
                                <p>Dincidunt ut laoreet dolore At vero eos et Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                    nibh euismod consectetuer adipiscing elit</p>
                            </li>
                        </ul>
                    </li>
                </ul>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 123 PVD, VN.</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 123456789 </li>
							<li class="mb-3">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">Lợi Store
			</p>
		</div>
	</div>
